...
//
	...
	public void setup() {
		...
		font = loadFont(FACE_PROPORTIONAL, STYLE_PLAIN, PMIDlet.SIZE_LARGE);
		//font = loadFont("data\\Arial-BoldMT-48.mvlw");
		textFont(font);
		//textAlign(CENTER);
	...
	public void draw() {
		...
		if (keyPressed) {
			text(String.valueOf(keyCode),50,50);
			text(String.valueOf(pointerX),50,80);
			switch (keyCode) {
			case UP:
				y = max(0, y - 1);
				break;
